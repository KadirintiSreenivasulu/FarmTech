...
//import db from "../components/Navbar/firebase";
        ...
        <form noValidate onSubmit={handleSubmit}>
            <div className={"inputContainer"}>
                <input
                    ...
                    onkeypress="return isLetters(event,this);" pattern="[a-zA-Z ]{3,15}"
                    title="First Name accepts only 3-15 characters" />
